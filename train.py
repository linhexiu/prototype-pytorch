...
if __name__ == '__main__':
    ...
    for epoch in range(1, args.max_epoch + 1):
        ...
        for i, batch in enumerate(tqdm(train_loader, desc='train_epoch:{}'.format(epoch))):
        ...
        for i, batch in enumerate(tqdm(val_loader, desc='val_epoch:{}'.format(epoch))):
            data, _ = [_.cuda() for _ in batch]
        ...
        vl = vl.item()
        va = va.item()
        print('epoch {}, train_loss={:.4f} train_acc={:.4f}, val_loss={:.4f} val_acc={:.4f}'.format(epoch, tl, ta, vl,
                                                                                                    va))
